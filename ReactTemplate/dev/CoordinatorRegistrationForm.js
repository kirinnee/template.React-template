...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/CoordinatorRegistrationForm_index.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/CoordinatorRegistrationForm_index.tsx":
/*!***************************************************!*\
  !*** ./src/CoordinatorRegistrationForm_index.tsx ***!
  \***************************************************/
/*! no exports provided */
...
/* harmony import */ var _Form_CoordinatorRegistrationForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Form/CoordinatorRegistrationForm */ "./src/Form/CoordinatorRegistrationForm.tsx");
...
c.ExtendPrimitives();
react_dom__WEBPACK_IMPORTED_MODULE_1__["render"](react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_Form_CoordinatorRegistrationForm__WEBPACK_IMPORTED_MODULE_3__["CoordinateRegister"], { formid: "CoordinateRegister" }), document.getElementById('app'));


/***/ }),

/***/ "./src/Form/CoordinatorRegistrationForm.tsx":
/*!**************************************************!*\
  !*** ./src/Form/CoordinatorRegistrationForm.tsx ***!
  \**************************************************/
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _FormComponents_NRIC__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../FormComponents/NRIC */ "./src/FormComponents/NRIC.tsx");
/* harmony import */ var _FormComponents_EmployeeNumber__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../FormComponents/EmployeeNumber */ "./src/FormComponents/EmployeeNumber.tsx");
/* harmony import */ var _FormComponents_Contact__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../FormComponents/Contact */ "./src/FormComponents/Contact.tsx");
/* harmony import */ var _FormComponents_Password__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../FormComponents/Password */ "./src/FormComponents/Password.tsx");
/* harmony import */ var _FormComponents_Name__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../FormComponents/Name */ "./src/FormComponents/Name.tsx");
...
var CoordinateRegister = /** @class */ (function (_super) {
    ...
    function CoordinateRegister(props) {
        ...
        _this.updateNRIC = function (nric) {
            _this.setState({ nric: nric });
        };
        _this.updateEmployeeNumber = function (employeeNumber) {
            _this.setState({ employeeNumber: employeeNumber });
        };
        ...
        _this.submitForm = function () {
            if (_this.state.name == '' ||
                _this.state.nric == null ||
                _this.state.employeeNumber == '' ||
                _this.state.contact == '' ||
                _this.state.password == null) {
                alert("Please fill in all fields before submitting the form");
            }
            else {
                sessionStorage.setItem(("Coordinator" + sessionStorage.length.toString()), JSON.stringify(_this.state));
    ...
    CoordinateRegister.prototype.render = function () {
        return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: 'form-container', id: this.props.formid },
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("form", null,
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_Name__WEBPACK_IMPORTED_MODULE_5__["NameInput"], { resetName: this.registerReset, getName: this.updateName }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_NRIC__WEBPACK_IMPORTED_MODULE_1__["NRICInput"], { resetNRIC: this.registerReset, getNRIC: this.updateNRIC }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_EmployeeNumber__WEBPACK_IMPORTED_MODULE_2__["EmployeeNumberInput"], { resetEmployeeNumber: this.registerReset, getEmployeeNumber: this.updateEmployeeNumber }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_Contact__WEBPACK_IMPORTED_MODULE_3__["ContactInput"], { resetContact: this.registerReset, getContact: this.updateContact }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_Password__WEBPACK_IMPORTED_MODULE_4__["PasswordInput"], { resetPassword: this.registerReset, getPassword: this.updatePassword }),
...
var EmployeeNumberInput = /** @class */ (function (_super) {
    ...
    function EmployeeNumberInput(props) {
        ...
        _this.setValue = function (event) {
            ...
            _this.props.getEmployeeNumber(event.target['value']);
        };
        props.resetEmployeeNumber(_this.resetValue);
        _this.state = { value: '' };
        return _this;
    }
...
var NRICInput = /** @class */ (function (_super) {
    ...
    function NRICInput(props) {
        var _this = _super.call(this, props) || this;
        _this.resetState = function () {
            _this.setState({ nric: '', valid: _Validation__WEBPACK_IMPORTED_MODULE_2__["Validity"].none });
        };
        _this.CheckNRICValidity = function (event) {
            var val = event.target['value'];
            var nric = val === null ? '' : val;
            _this.setState({ nric: nric });
            _this.props.getNRIC(nric);
        ...
        props.resetNRIC(_this.resetState);
...
/******/ });
//# sourceMappingURL=CoordinatorRegistrationForm.js.map