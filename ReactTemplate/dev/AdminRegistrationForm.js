...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/AdminRegistrationForm_index.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/AdminRegistrationForm_index.tsx":
/*!*********************************************!*\
  !*** ./src/AdminRegistrationForm_index.tsx ***!
  \*********************************************/
/*! no exports provided */
...
/* harmony import */ var _Form_AdminRegistrationForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Form/AdminRegistrationForm */ "./src/Form/AdminRegistrationForm.tsx");
...
c.ExtendPrimitives();
react_dom__WEBPACK_IMPORTED_MODULE_1__["render"](react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_Form_AdminRegistrationForm__WEBPACK_IMPORTED_MODULE_3__["AdminRegistrationForm"], { formid: "AdminRegistrationForm" }), document.getElementById('app'));


/***/ }),

/***/ "./src/Form/AdminRegistrationForm.tsx":
/*!********************************************!*\
  !*** ./src/Form/AdminRegistrationForm.tsx ***!
  \********************************************/
/*! exports provided: AdminRegistrationForm */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdminRegistrationForm", function() { return AdminRegistrationForm; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _FormComponents_Contact__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../FormComponents/Contact */ "./src/FormComponents/Contact.tsx");
/* harmony import */ var _FormComponents_Name__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../FormComponents/Name */ "./src/FormComponents/Name.tsx");
/* harmony import */ var _FormComponents_Designation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../FormComponents/Designation */ "./src/FormComponents/Designation.tsx");
/* harmony import */ var _FormComponents_Department__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../FormComponents/Department */ "./src/FormComponents/Department.tsx");
/* harmony import */ var _FormComponents_Email__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../FormComponents/Email */ "./src/FormComponents/Email.tsx");
/* harmony import */ var _FormComponents_Password__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../FormComponents/Password */ "./src/FormComponents/Password.tsx");
...
var AdminRegistrationForm = /** @class */ (function (_super) {
    __extends(AdminRegistrationForm, _super);
    function AdminRegistrationForm(props) {
        var _this = _super.call(this, props) || this;
        _this.updateName = function (name) {
            _this.setState({ name: name });
        };
        _this.updateContact = function (contact) {
            _this.setState({ contact: contact });
        };
        _this.updateDesignation = function (designation) {
            _this.setState({ designation: designation });
        };
        _this.updateDepartment = function (department) {
            _this.setState({ department: department });
        };
        ...
        _this.registerReset = function (event) {
            var arr = _this.state.reset;
            arr.push(event);
            _this.setState({ reset: arr });
        };
        ...
        _this.submitForm = function () {
            if (_this.state.name == '' ||
                _this.state.designation == null ||
                _this.state.department == '' ||
                _this.state.contact == '' ||
                ...
                sessionStorage.setItem(("Admin" + sessionStorage.length.toString()), JSON.stringify(_this.state));
                alert("Thank you, " + _this.state.name + "! We will get back to you after we process your registration!");
                console.log(_this.state);
                _this.resetFields();
                _this.state.reset.Every(function (f) { return f(); });
                console.log(_this.state);
            }
        };
        _this.state = {
    ...
    AdminRegistrationForm.prototype.render = function () {
        return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: 'form-container', id: this.props.formid },
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("form", null,
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_Name__WEBPACK_IMPORTED_MODULE_2__["NameInput"], { resetName: this.registerReset, getName: this.updateName }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_Designation__WEBPACK_IMPORTED_MODULE_3__["DesignationInput"], { resetDesignation: this.registerReset, getDesignation: this.updateDesignation }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_Department__WEBPACK_IMPORTED_MODULE_4__["DepartmentInput"], { resetDepartment: this.registerReset, getDepartment: this.updateDepartment }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_Contact__WEBPACK_IMPORTED_MODULE_1__["ContactInput"], { resetContact: this.registerReset, getContact: this.updateContact }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_Email__WEBPACK_IMPORTED_MODULE_5__["EmailInput"], { resetEmail: this.registerReset, getEmail: this.updateEmail }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_Password__WEBPACK_IMPORTED_MODULE_6__["PasswordInput"], { resetPassword: this.registerReset, getPassword: this.updatePassword }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("hr", null),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("input", { type: "button", value: "Submit", onClick: this.submitForm }))));
    };
...
var ContactInput = /** @class */ (function (_super) {
    ...
    function ContactInput(props) {
        ...
        _this.setValue = function (event) {
            ...
            _this.props.getContact(event.target['value']);
        };
        props.resetContact(_this.resetState);
        _this.state = { value: '' };
        return _this;
    }
...
/***/ "./src/FormComponents/Department.tsx":
/*!*******************************************!*\
  !*** ./src/FormComponents/Department.tsx ***!
  \*******************************************/
/*! exports provided: DepartmentInput */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DepartmentInput", function() { return DepartmentInput; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _FormInput__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FormInput */ "./src/FormComponents/FormInput.tsx");
var __extends = (undefined && undefined.__extends) || (function () {
...
var DepartmentInput = /** @class */ (function (_super) {
    __extends(DepartmentInput, _super);
    function DepartmentInput(props) {
        var _this = _super.call(this, props) || this;
        _this.resetState = function () {
            _this.setState({
                department: ""
        ...
        _this.setValue = function (event) {
            ...
            _this.props.getDepartment(event.target['value']);
        };
        props.resetDepartment(_this.resetState);
        _this.state = { department: '' };
        return _this;
    }
    DepartmentInput.prototype.render = function () {
        return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormInput__WEBPACK_IMPORTED_MODULE_1__["FormInput"], { cls: '', label: 'Department', type: 'text', value: this.state.department, addition: undefined, change: this.setValue }));
    };
...
/***/ "./src/FormComponents/Designation.tsx":
/*!********************************************!*\
  !*** ./src/FormComponents/Designation.tsx ***!
  \********************************************/
/*! exports provided: DesignationInput */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DesignationInput", function() { return DesignationInput; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _FormInput__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FormInput */ "./src/FormComponents/FormInput.tsx");
var __extends = (undefined && undefined.__extends) || (function () {
...
var DesignationInput = /** @class */ (function (_super) {
    __extends(DesignationInput, _super);
    function DesignationInput(props) {
        var _this = _super.call(this, props) || this;
        _this.resetState = function () {
            _this.setState({ value: '' });
        };
        _this.setValue = function (event) {
            ...
            _this.props.getDesignation(event.target['value']);
        };
        props.resetDesignation(_this.resetState);
        _this.state = { value: '' };
        return _this;
    }
    DesignationInput.prototype.render = function () {
        return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormInput__WEBPACK_IMPORTED_MODULE_1__["FormInput"], { cls: '', label: 'Designation', type: 'text', value: this.state.value, addition: undefined, change: this.setValue }));
    };
...
/* harmony import */ var _Modules_EmailValidation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Modules/EmailValidation */ "./src/Modules/EmailValidation.tsx");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var EmailInput = /** @class */ (function (_super) {
    ...
    function EmailInput(props) {
        ...
        _this.resetState = function () {
            _this.setState({
                value: '',
                emailValid: _Validation__WEBPACK_IMPORTED_MODULE_2__["Validity"].none,
                invalidEmail: ''
            });
        };
        _this.IsEmailValid = function (event) {
            var value = event.target['value'];
            if (Object(_Modules_EmailValidation__WEBPACK_IMPORTED_MODULE_3__["ValidateEmail"])(value)) {
                _this.setState({
                    value: value,
                    emailValid: _Validation__WEBPACK_IMPORTED_MODULE_2__["Validity"].valid,
                    invalidEmail: ''
                });
                _this.props.getEmail(value);
            }
            else {
                _this.setState({
                    value: value,
                    emailValid: _Validation__WEBPACK_IMPORTED_MODULE_2__["Validity"].invalid,
                    invalidEmail: 'Email does not match email address format'
                });
                _this.props.getEmail(null);
            }
        };
        props.resetEmail(_this.resetState);
        _this.state =
            {
                value: '',
                emailValid: _Validation__WEBPACK_IMPORTED_MODULE_2__["Validity"].none,
    ...
    EmailInput.prototype.render = function () {
        return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormInput__WEBPACK_IMPORTED_MODULE_1__["FormInput"], { cls: '', label: 'Email', type: 'text', value: this.state.value, addition: react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_Validation__WEBPACK_IMPORTED_MODULE_2__["ValidityIcon"], { valid: this.state.emailValid, message: this.state.invalidEmail }), change: this.IsEmailValid }));
    };
    return EmailInput;
}(react__WEBPACK_IMPORTED_MODULE_0__["Component"]));
...
var NameInput = /** @class */ (function (_super) {
    ...
    function NameInput(props) {
        ...
        _this.setValue = function (event) {
            ...
            _this.props.getName(value);
        };
        props.resetName(_this.resetState);
        _this.state = { value: '' };
        return _this;
    }
...
var PasswordInput = /** @class */ (function (_super) {
    ...
    function PasswordInput(props) {
        ...
        props.resetPassword(_this.resetState);
        _this.state = {
            password: '',
            repeatpassword: '',
            passwordValid: _Validation__WEBPACK_IMPORTED_MODULE_2__["Validity"].none,
...
/***/ "./src/Modules/EmailValidation.tsx":
/*!*****************************************!*\
  !*** ./src/Modules/EmailValidation.tsx ***!
  \*****************************************/
...
var content = __webpack_require__(/*! !../node_modules/css-loader??ref--6-1!../node_modules/sass-loader/lib/loader.js?sourceMap!./style.scss */ "./node_modules/css-loader/index.js?!./node_modules/sass-loader/lib/loader.js?sourceMap!./src/style.scss");
...
/******/ });
//# sourceMappingURL=AdminRegistrationForm.js.map