...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/BusinessRegistrationForm_index.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
var Address = /** @class */ (function (_super) {
    ...
    function Address(props) {
        ...
        props.resetAddress(_this.resetState);
        _this.state =
            {
                lineOne: '',
                lineTwo: '',
    ...
    Address.prototype.render = function () {
        return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { id: "address-form-group", className: "form-group" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "form-input-holder" },
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("input", { className: "input-size", name: "lineOne", type: "text", placeholder: "Line One", value: this.state.lineOne, onChange: this.handleChange }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("input", { className: "input-size", name: "lineTwo", type: "text", placeholder: "Line Two", value: this.state.lineTwo, onChange: this.handleChange }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("input", { className: "input-size", name: "postalCode", type: "text", placeholder: "Postal Code", value: this.state.postalCode, onChange: this.handleChange }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("input", { className: "input-size", name: "city", type: "text", placeholder: "City", value: this.state.city, onChange: this.handleChange }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("input", { className: "input-size", name: "country", type: "text", placeholder: "Country", value: this.state.country, onChange: this.handleChange }))));
    };
    return Address;
...
/***/ "./src/BusinessRegistrationForm_index.tsx":
/*!************************************************!*\
  !*** ./src/BusinessRegistrationForm_index.tsx ***!
  \************************************************/
/*! no exports provided */
...
/* harmony import */ var _Form_BusinessRegistrationForm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Form/BusinessRegistrationForm */ "./src/Form/BusinessRegistrationForm.tsx");
...
c.ExtendPrimitives();
react_dom__WEBPACK_IMPORTED_MODULE_1__["render"](react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_Form_BusinessRegistrationForm__WEBPACK_IMPORTED_MODULE_3__["ServiceVendorBusinessForm"], { formid: "ServiceVendorBusinessForm" }), document.getElementById('app'));


/***/ }),

/***/ "./src/Form/BusinessRegistrationForm.tsx":
/*!***********************************************!*\
  !*** ./src/Form/BusinessRegistrationForm.tsx ***!
  \***********************************************/
...
/* harmony import */ var _FormComponents_FormInput__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../FormComponents/FormInput */ "./src/FormComponents/FormInput.tsx");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ServiceVendorBusinessForm = /** @class */ (function (_super) {
    ...
    ServiceVendorBusinessForm.prototype.submitForm = function () {
        if (this.state.name == '' ||
            ...
            console.log(this.state);
            this.resetFields();
            this.state.reset.Every(function (f) { return f(); });
        }
    };
    ServiceVendorBusinessForm.prototype.render = function () {
        return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: 'form-container', id: this.props.formid },
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("form", null,
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_Name__WEBPACK_IMPORTED_MODULE_3__["NameInput"], { resetName: this.registerReset, getName: this.updateName }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_Address__WEBPACK_IMPORTED_MODULE_1__["Address"], { resetAddress: this.registerReset, updateAddress: this.updateAddress }),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_FormComponents_FormInput__WEBPACK_IMPORTED_MODULE_4__["FormInput"], { cls: '', addition: undefined, type: 'text', label: 'UEN', value: this.state.uen, change: this.updateUEN }),
                ...
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"](_PaymentPreference__WEBPACK_IMPORTED_MODULE_2__["PaymentPreference"], { resetPaymentPreference: this.registerReset, updatePaymentPreference: this.updatePaymentPreference }),
...
var PaymentPreference = /** @class */ (function (_super) {
    ...
    function PaymentPreference(props) {
        ...
        props.resetPaymentPreference(_this.resetState);
        _this.state =
            {
                preferredPaymentOptions: []
            };
    ...
    PaymentPreference.prototype.render = function () {
        return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { id: "payment-preference-form-group", className: "form-group" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: "form-input-holder" },
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("input", { name: "Cash", type: "checkbox", onClick: this.handleClick, checked: this.state.preferredPaymentOptions.Contains("Cash") }),
                "Cash ",
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("input", { name: "Cheque", type: "checkbox", onClick: this.handleClick, checked: this.state.preferredPaymentOptions.Contains("Cheque") }),
                "Cheque ",
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("input", { name: "PayNow", type: "checkbox", onClick: this.handleClick, checked: this.state.preferredPaymentOptions.Contains("PayNow") }),
                "PayNow ",
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("br", null),
                react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("input", { name: "Internet Banking", type: "checkbox", onClick: this.handleClick, checked: this.state.preferredPaymentOptions.Contains("Internet Banking") }),
                "Internet Banking")));
    };
...
/******/ });
//# sourceMappingURL=BusinessRegistrationForm.js.map